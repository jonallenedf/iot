...
namespace fwupdatedevice
{
    class SimulatedDevice
    {
        ...
        static string s_deviceConnectionString = "HostName=cavemanagement-1231321321.azure-devices.net;DeviceId=cave-device-01;SharedAccessKey=ULNuqXDoKTB8/NM3bXxqSJKaU+lV9YXvftWdpBAszVA=";

        // Device ID variable
        static string DeviceID="cave-device-01";
