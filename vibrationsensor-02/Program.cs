...
namespace vibration_device
{
    class SimulatedDevice
    {
        ...
        private readonly static string s_deviceConnectionString = "HostName=edfdemohub.azure-devices.net;DeviceId=VibrationSensor-02;SharedAccessKey=9GS1pyKAojC/MhzSl/mAfbLS3i1JXhWsE0Ju8l0wEdE=";
        ...
        private static async void SendDeviceToCloudMessagesAsync(Random rand)
        {
            ...
            while (true)
            {
                ...
                telemetryMessage.Properties.Add("sensorID", "VSTel02");
                ...
                // Add a custom application property to the message. This is used to route the message.
                loggingMessage.Properties.Add("sensorID", "VSLog02");
